...
const pump = __nccwpck_require__(4889);
const bufferStream = __nccwpck_require__(6649);
...
const normalizeUrl = __nccwpck_require__(8806);
const getStream = __nccwpck_require__(8189);
const CachePolicy = __nccwpck_require__(9450);
const Response = __nccwpck_require__(4699);
const lowercaseKeys = __nccwpck_require__(3156);
const cloneResponse = __nccwpck_require__(2333);
const Keyv = __nccwpck_require__(9375);
...
const mimicResponse = __nccwpck_require__(454);
...
const mimicResponse = __nccwpck_require__(4496);
...
const {promisify} = __nccwpck_require__(3837);
const bufferStream = __nccwpck_require__(1486);
...
const QuickLRU = __nccwpck_require__(7810);
const delayAsyncDestroy = __nccwpck_require__(9047);
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const resolveALPN = __nccwpck_require__(2906);
const QuickLRU = __nccwpck_require__(7810);
const {Agent, globalAgent} = __nccwpck_require__(6080);
const Http2ClientRequest = __nccwpck_require__(1029);
const calculateServerName = __nccwpck_require__(2667);
const delayAsyncDestroy = __nccwpck_require__(9047);
...
const {Agent, globalAgent} = __nccwpck_require__(6080);
const IncomingMessage = __nccwpck_require__(9725);
const proxyEvents = __nccwpck_require__(8113);
const {
	ERR_INVALID_ARG_TYPE,
	ERR_INVALID_PROTOCOL,
	ERR_HTTP_HEADERS_SENT
} = __nccwpck_require__(4933);
const validateHeaderName = __nccwpck_require__(8953);
const validateHeaderValue = __nccwpck_require__(7633);
const proxySocketHandler = __nccwpck_require__(2006);
...
const {
	Agent,
	globalAgent
} = __nccwpck_require__(6080);
const ClientRequest = __nccwpck_require__(1029);
const IncomingMessage = __nccwpck_require__(9725);
const auto = __nccwpck_require__(5110);
const {
	HttpOverHttp2,
	HttpsOverHttp2
} = __nccwpck_require__(3848);
const Http2OverHttp2 = __nccwpck_require__(6395);
const {
	Http2OverHttp,
	Http2OverHttps
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const JSStreamSocket = __nccwpck_require__(4392);
const {globalAgent} = __nccwpck_require__(6080);
const UnexpectedStatusCodeError = __nccwpck_require__(1221);
const initialize = __nccwpck_require__(2704);
const getAuthorizationHeaders = __nccwpck_require__(3037);
...
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const Http2OverHttpX = __nccwpck_require__(985);
const getAuthorizationHeaders = __nccwpck_require__(3037);
...
const {Agent} = __nccwpck_require__(6080);
const JSStreamSocket = __nccwpck_require__(4392);
const UnexpectedStatusCodeError = __nccwpck_require__(1221);
const initialize = __nccwpck_require__(2704);
...
// eslint-disable-next-line node/prefer-global/url
const {URL} = __nccwpck_require__(7310);
const checkType = __nccwpck_require__(737);
...
const {ERR_HTTP2_NO_SOCKET_MANIPULATION} = __nccwpck_require__(4933);
...
const {ERR_INVALID_HTTP_TOKEN} = __nccwpck_require__(4933);
const isRequestPseudoHeader = __nccwpck_require__(7469);
...
const EventEmitter = __nccwpck_require__(2361);
const JSONB = __nccwpck_require__(4689);
...
var once = __nccwpck_require__(7387)
var eos = __nccwpck_require__(2181)
...
/* harmony import */ var got__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(9853);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(822);
...
try {
    const request = {
        headers: {
            ...
            "X-Auth-Email": _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput("cf-email"),
            "X-Auth-Key": _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('cf-token'),
        },
    }
    const cfAccountID = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('cf-account-id');
    const cfProjectName = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('cf-project-name');
    ...
    const {result} = await got__WEBPACK_IMPORTED_MODULE_2__/* ["default"].get */ .ZP.get(deployments_endpoint_base, request).json();

    lodash__WEBPACK_IMPORTED_MODULE_1__.forEach(result, (function (deploy) {
...
var dist = __nccwpck_require__(4247);
...
var source = __nccwpck_require__(3485);
...
var src = __nccwpck_require__(7800);
// EXTERNAL MODULE: ./node_modules/decompress-response/index.js
var decompress_response = __nccwpck_require__(5152);
// EXTERNAL MODULE: ./node_modules/get-stream/index.js
var get_stream = __nccwpck_require__(4233);
...
var cacheable_lookup_source = __nccwpck_require__(8204);
// EXTERNAL MODULE: ./node_modules/http2-wrapper/source/index.js
var http2_wrapper_source = __nccwpck_require__(8933);
